...
(*
Rely on zero-crossing detection on
a DISCONTINUOUS function during integration 

Nothing particular compared to cradle2 since
behavior does not depend on zero "takeoff"
*)
...
let hybrid main () =
  ...
  present (period (0.05)) ->
      ...
      in Scope.window ("cradle2bool", 3.0, t, s)
  else ()
