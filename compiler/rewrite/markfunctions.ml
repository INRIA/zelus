...
let implementation impl =
  ...
  | Eopen _ | Etypedecl _ | Econstdecl _ | Erefinementdecl _ -> impl | Ecustom_refinementdecl _ -> impl
  | Erefinementfundecl(n, funexp, _) | Ecustom_refinementfundecl(n, funexp, _) | Efundecl(n, funexp) ->
