...
\begin{tikzpicture}[
   ...
   \path
    (False) edge [weak,bend left] node {\zls{on\_off}} (True)
    (True)  edge [weak,bend left] node {\zls{on\_off}} (False)
    ;
   ...
   \path
    (False) edge [strong,bend left] node {\zls{on\_off}} (True)
    (True)  edge [strong,bend left] node {\zls{on\_off}} (False)
    ;
