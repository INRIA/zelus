...
\zls{Up} mode whereas equation \zls{c2 = 1 -> pre c2 + 1} is
active in mode \zls{Down}. The execution diagram is given below.
\begin{chrono}{l|cccccccc}
\hline
\tt i                 & \tt 0  & \tt 0  & \tt 0 & \tt 0    & \tt 0  & \tt 0    &  \tt 0  & \dots \\
\hline
...
instants where \zls{m = Up} and the other denoting the instant where
\zls{m = Down}.
