...
develop.
If you find it useful, please consider cite our work~\cite{lucy:hscc13} and 
sending us comments.
...
% }-}1
\chapter{Synchronous Programming} %{-{1
\label{chap:synchronous-programming}
...
every ground type or scalar value is imported from the host language
...
% }-}1
\chapter{Hybrid Systems Programming} %{-{1
\label{chap:ode-programming}
...
\cref{chap:synchronous-programming}. They are identified
...
\cref{chap:synchronous-programming}, \texttt{last y'} is the
...
% }-}1
\chapter{The Simulation Loop} %{-{1
\label{chap:simulation-loop}
