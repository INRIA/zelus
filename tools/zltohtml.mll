...
List.iter (fun (str, i) -> if Hashtbl.mem Lexer.keyword_table str then
...
let print_empty_css () =
  print "pre.zelus span.keyword { color: green; }\n";
  ...
  StringSet.iter (fun c -> print "pre.zelus span."; print c; print " { }\n")
                 (StringSet.remove "keyword" classes);

  print "pre.zelus span.comment { color: gray; }\n";
  print "pre.zelus span.comment span.string { color: gray; }\n";
  print "pre.zelus span.comment span.character { color: gray; }\n"
